...
const detailShare = (country) => {  //ccn3 es el codigo numerico del pais
    ...
    return  `
    <div class="card">
        <img loading="lazy" onclick="viewDetail('${code}')" src="${country.flags.png}" alt="Bandera de ${country.flags.alt}" class="card__image"/>
        ...
        <div class="card__continent">
            <img loading="lazy" src="../../assets/${country.region}-outline.png" />
        </div>
    </div>
